...
const MultiColumnDropdown = ({ open, setOpen, value, setValue }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="modal-content relative bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-2"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex space-x-6">
          <div className="dropdown-wrapper flex flex-col w-1/2">
            <label className="text-xs font-medium text-gray-700 mb-2">Select Month</label>
            <Select
              value={selectedMonth}
          ...
          <div className="dropdown-wrapper flex flex-col w-1/2">
            <label className="text-xs font-medium text-gray-700 mb-2">Select Year</label>
            <Select
              value={selectedYear}
        ...
        <button
          className="apply-button mt-6 w-full text-sm bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 focus:outline-none"
          onClick={handleApply}
        >
          Apply
        </button>
