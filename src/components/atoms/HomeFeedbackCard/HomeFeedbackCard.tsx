...
const HomeFeedbackCard = () => {
  ...
  return (
    <>
      <div
  className="flex gap-4 px-2 py-2 overflow-x-auto scrollbar-none"
  style={{
...
>
  ...
  >
    ...
    <p className="text-xs font-semibold text-gray-600 mt-2">Suggestion Box</p>
  </div>
  <div
    className="flex-shrink-0 bg-white rounded-lg p-4 text-center cursor-pointer border border-gray-300 flex flex-col items-center justify-center"
    style={{ width: "33.33%" }}
  ...
  >
    ...
    <p className="text-xs font-semibold text-gray-600 mt-2">Complaint Box</p>
  </div>
  <div
    className="flex-shrink-0 bg-white rounded-lg p-4 text-center cursor-pointer border border-gray-300 flex flex-col items-center justify-center"
    style={{ width: "33.33%" }}
  ...
  >
    ...
    <p className="text-xs font-semibold text-gray-600 mt-2">Leader Board</p>
  </div>
</div>
      ...
      {modalVisible && (
        ...
        >
          <div
            className="bg-white p-6 rounded-lg max-w-lg w-full mx-8"
              ...
              <>
                ...
                {modalType === "feedback" ? (
                  <div className="mb-4">
                    ...
                    <textarea
                      className="w-full h-36 p-2 border border-gray-300 rounded-lg mt-2"
                  ...
                  <textarea
                    className="w-full h-36 p-2 border border-gray-300 rounded-lg"
                    placeholder="Write freely! It's always anonymous!"
                    value={
                      modalType === "suggestion"
                        ? suggestionComments
