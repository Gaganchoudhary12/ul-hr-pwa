...
const EventsSection = () => {
  ...
  return (
    <div className="flex flex-col mx-0 pb-5 mt-4">
      <h2 className="text-l font-semibold text-gray-800 text-left">The Monthly Roundup</h2>
      <p className="text-xs font-normal mt-1 text-gray-800 leading-5">
