...
export default function Home() {
  ...
  return (
    <>
      <Header />
      <div className="w-full mx-auto p-3 bg-white-100">
        <div>
          <HomeFeedbackCard />
...
const MoodSelection = ({
  ...
  <div className="text-center">
    ...
    <button
      className="mt-5 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded text-sm"
...
const ThankYouContent = ({ firstName, dailyRating, onClose }) => {
  ...
  return (
    <div className="text-center">
      ...
      <p className="mt-3 text-gray-600 text-sm">{legend[dailyRating]}</p>
      <button
        className="mt-5 bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded text-sm"
        onClick={onClose}
      >
        Ok Got it
      </button>
