...
const Idea = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col pt-2 bg-white rounded-3xl px-4">
        <div className="flex items-center justify-between p-4 rounded-md bg-[#D9ECFF] w-full h-[120px] my-6 self-center">
          <div>
            <h2 className="text-[#333333] text-sm font-semibold">
              The Innovation Hub
            </h2>
        ...
        <div className="relative z-10">
          <div className="my-2 cursor-pointer" onClick={toggleModal}>
            <div className="relative w-full">
              <label className="absolute top-[-8px] left-2 text-xs text-[#7B7A80] bg-white px-1">
                Select Department
              </label>
              <div className="h-[52px] border border-[#E8E8E8] rounded-lg bg-white px-4 py-4 text-[#AEAEBC] text-base font-semibold w-full">
                <p className="placeholder text-xs">Eg product</p>
              </div>
          ...
          <div className="flex flex-wrap mt-4">
            {selectedDepartments.map((dept, index) => (
              <div
                key={index}
                className={`flex items-center bg-#D9ECFF rounded-3xl px-2 py-2 mr-2 mb-2 border ${
                  index === 0
        ...
        {selectedDepartments.length > 0 && (
          <div className="mt-3 w-full">
            ...
            <textarea
              className="w-full h-[120px] border border-[#E8E8E8] rounded-lg mt-3 p-2 text-base text-xs text-[#333333]"
              value={ideas}
        ...
        <button
          className={`bg-[#007AFF] text-white font-semibold text-sm py-3 rounded-lg w-full mt-4 cursor-pointer ${
