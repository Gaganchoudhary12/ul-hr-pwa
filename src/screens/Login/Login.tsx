  ...
  return (
    <div className="flex flex-col justify-center items-center bg-white h-screen">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-lg font-light text-center mt-2 text-gray-600 w-3/4">
          Discover the Key to a More Positive and Productive Workplace
        </p>
      </div>

      <div className="flex flex-col items-center pb-16 mx-2">
        {loading ? (
      ...
      {modalVisible && (
        <div className="fixed top-0 left-0 w-screen h-screen bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-5 rounded-lg text-center mx-2">
            ...
            <button
              onClick={closeModal}
              className="bg-blue-500 w-72 rounded-sm text-lg mt-2 py-2 text-white cursor-pointer"
            >
              OK
            </button>
          </div>
