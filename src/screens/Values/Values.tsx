  ...
  return (
    ...
    <div className="px-5 bg-white rounded-xl">
      ...
      <div className="flex justify-center mt-6">
        <button
          className="w-80 py-2.5 px-5 bg-transparent border border-gray-300 rounded-lg text-lg text-gray-800 text-center"
          onClick={() => setDropdownOpen(true)}
        >
          <span className="text-xl">{selectedValue}</span>
        </button>
        <MultiColumnDropdown
          open={dropdownOpen}
      ...
      {view !== "rateEmployees" && (
        <button
          className="w-full py-3 bg-blue-600 text-white text-center rounded-lg disabled:bg-gray-300 disabled:cursor-not-allowed"
          onClick={() => {
