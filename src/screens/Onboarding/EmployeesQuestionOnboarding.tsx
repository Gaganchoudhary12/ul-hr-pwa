...
const EmployeesQuestionOnboarding = () => {
  ...
  return (
    <>
      ...
      />
      <div className="px-5 py-8 bg-white rounded-t-2xl mt-[-20px] pb-10">
        <div className="pb-5">
          ...
          <div className="flex flex-wrap justify-between mt-3">
            {[1, 2, 3, 4, 5].map((rating) => (
              <button
                key={rating}
                className={`w-12 h-12 flex justify-center items-center rounded-full my-2 text-lg cursor-pointer transition-all ${
                  (selfRating[title]?.[
