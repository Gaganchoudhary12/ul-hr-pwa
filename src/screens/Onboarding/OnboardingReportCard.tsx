...
const OnboardingReportCard = () => {
      ...
      if (managerRating !== undefined && selfRatingValue !== undefined) {
        ...
        return (
          <div key={index} className="flex justify-between bg-white border border-gray-200 p-4 rounded-lg mb-2">
            <div>
              <span className="text-sm font-semibold text-gray-800 mb-2 block w-20">{item}</span>
              <span
            ...
            <div>
              ...
              <span className="text-xs font-normal text-gray-500 mt-2 block">Your Score</span>
            </div>
            ...
            <div>
              ...
              <span className="text-xs font-normal text-gray-500 mt-2 block">Manager Score</span>
            </div>
          </div>
        );
      } else {
  ...
  return (
    <>
      ...
      />
      <div className="flex-1 mt-[-20px] pb-10 pt-8 bg-white rounded-t-2xl">
        ...
        <div className="my-2 mx-6">
          <span className="text-lg font-semibold text-gray-800">Onboarding Results</span>
          <span className="text-xs font-normal text-gray-600 block mt-1">Acknowledging your journey and gearing up for more!</span>
          <span className="text-center text-lg font-semibold text-gray-800 mt-2 block">
            Overall Score
          </span>
        </div>
